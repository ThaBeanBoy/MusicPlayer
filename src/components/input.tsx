              ...
              <Tooltip.Provider>
                <Tooltip.Root>
                  ...
                  <Tooltip.Portal>
                    <Tooltip.Content
                      side='right'
                      className='max-w-sm w-60 data-[state=delayed-open]:data-[side=top]:animate-slideDownAndFade border-red-600 border data-[state=delayed-open]:data-[side=right]:animate-slideLeftAndFade data-[state=delayed-open]:data-[side=left]:animate-slideRightAndFade data-[state=delayed-open]:data-[side=bottom]:animate-slideUpAndFade select-none rounded-[4px] bg-white px-[15px] py-[10px] text-sm leading-none shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] will-change-[transform,opacity]'
                    >
                      <ul>
